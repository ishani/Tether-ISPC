...
// contains some edits. targets float
#include <cstdlib>
#include <cmath>
#include <cfloat>
...
namespace dsp
{
    namespace detail
    {
        static constexpr auto f_pi = 3.14159265358979323846264338327950288f;
        ...
        {
            return (A * f_pi / B) * sin_cos_series( 2, 34, B, A );
        }
        ...
        // manual unrolling saves a lump of performance
        template<>
